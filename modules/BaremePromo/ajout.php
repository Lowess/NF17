<fieldset>
	...
	<form enctype="multipart/form-data" action='?module=BaremePromo&action=valide' method='post' class='form_ajout'>
			...
			<label>Bareme Promotion</label>
			<input type='hidden' id='pointfidelite' name='pointfidelite' value="<?php echo Form::get('pointfidelite') ?>">
			<input type='text' id='baremepromo' name='baremepromo' value="<?php echo Form::get('baremepromo') ?>">
			
			<div class="endform">
				<a href="?module=BaremePromo" style="text-decoration:none"><input type='reset' value='Annuler' class='valider'></a>
