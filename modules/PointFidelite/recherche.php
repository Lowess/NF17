<fieldset>
	<legend>Critères de recherche</legend>
		<form action='?module=PointFidelite&action=recherche' id="recherche" method='post' class='form_recherche'>
		...
		<p class="endform">
			...
			<a href='?module=PointFidelite'><input type="reset" value="Réinitialiser" class="btn"></a>
